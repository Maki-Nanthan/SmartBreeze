...
def parse_args():
    ...
    parser.add_argument("--data", default=str(PROJECT_ROOT / "data_science" / "classroom_person.yaml"), help="YOLO dataset YAML.")
    parser.add_argument("--model", default=str(PROJECT_ROOT / "yolo11n.pt"), help="Starting YOLO weights.")
...
def main():
    ...
    print("Use it with:")
    print(f"python developer/backend/backend_simulation_server.py --video \"videos/HIGH.MOV\"")
